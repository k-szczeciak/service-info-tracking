...
Features:
TBD - User account and authoristaion profiles
...
TBF - Adding documents for each Item/Case - file based - each Item/Case has its own folder (preview)
TBD - forms validation
